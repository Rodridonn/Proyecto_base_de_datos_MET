          ...
          <div class="row align-items-center">
            ...
            <div class="row d-flex justify-content-between">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card-body">
                  <a href="{{ url('/metsltr/create' )}}" class="btn btn-sm btn-primary btn-block flex-fill">Añadir nuevo registro</a>
                </div>
              </div>
            </div>
          ...
          <table id="tablaespecial" class="table align-items-center table-flush">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form action="{{url('/metsltr/'.$met->id)}}" method="POST">  {{-- botones de editar y eliminar --}} 
                    @csrf
                    @method('DELETE')
